...
<div class="alert alert-dismissible alert-info">
 <h2 class="alert-heading">
  ...
  <HR>
  <p class="mb-0">Una de dos o más formas alternativas de un gen. Por ejemplo, en los cruces de Mendel, el color de la semilla fue determinada por un gen que existe como dos <font color="black"><u>alelos</font></u> diferentes.</p>
</div>
...
<div class="alert alert-dismissible alert-primary">
  ...
  <HR>
  <p class="mb-0">Lugar específico en un cromosoma ocupado por un alelo. Por lo tanto, hay un lugar específico, un <font color="black"><u>locus</font></u>, en un cromosoma en las plantas de guisantes donde se determina el color de las semillas.</p>
</div>
