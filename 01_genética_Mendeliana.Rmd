...
<div style='text-align:justify'><font color="black"><i class="fa fa-hand-spock-o"></font></i> Si ves algo mal, <a href="mailto:jollopezma@unal.edu.co">¡hazmelo saber!</a> También estoy abierto a sugerencias.</div>
...
Guisantes <- data.frame(
  ...
  geom_fontawesome('fa-circle', x = 1.48, y = 1.405, size = 18.4, color = 'gray54') +
  geom_fontawesome('fa-circle', x = 1.54, y = 1.405, size = 18.4, color = 'yellow') +
  annotate(geom = 'text', x = 1.98, y = 1.405, label = 'Color de la capa de las semillas', family = 'gochi', size = 14.8, colour = 'black') +
  geom_fontawesome('fa-arrows-v', x = 1.48, y = 1.4, size = 28.4, color = 'black') +
  geom_fontawesome('fa-arrows-v', x = 1.54, y = 1.4, size = 18.4, color = 'black') +
  annotate(geom = 'text', x = 1.82, y = 1.4, label = 'Longitud del tallo', family = 'gochi', size = 14.8, colour = 'black') +
  scale_y_continuous(limits = c(1.396, 1.41)) +
  scale_x_continuous(limits = c(1.18, 2.4)) +
  theme_void() +
