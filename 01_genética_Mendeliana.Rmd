...
Grafo_GM_2 <- data.frame(
  ...
  annotate(geom = 'segment', x = 5.9, xend = 5.9, y = 1.2, yend = 1.5, colour = 'black', size = 1.0, linetype = 'twodash') +
  geom_curve(x = 5.9, xend = 4.4, y = 1.2, yend = 1.2, arrow = arrow(length = unit(0.1, 'inch')), size = 1.0, color = 'black', curvature = 0.0, linetype = 'twodash') +
  annotate(geom = 'text', x = 6.0, y = 1.0, label = 'Causalidad', family = 'gochi', size = 8.2, colour = 'black') +
  annotate(geom = 'segment', x = 1.0, xend = 1.2, y = 6.0, yend = 5.5, colour = 'black', size = 1.0, linetype = 'twodash') +
  annotate(geom = 'segment', x = 1.0, xend = 1.0, y = 6.6, yend = 6.0, colour = 'black', size = 1.0, linetype = 'twodash') +
  annotate(geom = 'segment', x = 5.6, xend = 1.0, y = 6.68, yend = 6.68, colour = 'black', size = 1.0, linetype = 'twodash') +
  geom_curve(x = 5.6, xend = 5.8, y = 6.68, yend = 6.5, arrow = arrow(length = unit(0.1, 'inch')), size = 1.0, color = 'black', curvature = 0.0, linetype = 'twodash') +
